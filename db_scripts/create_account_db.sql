-- ============================================================================
-- account_db — bank account and balance store for account-service
-- Run: sudo -u postgres psql < /path/to/create_account_db.sql
-- ============================================================================
...
COMMENT ON DATABASE account_db IS 'account-service: bank accounts, balances, deposit and withdrawal records.';

-- Grant privileges (only needed if you connect as a role other than postgres;
-- config-repo/account-service.yml currently connects as the postgres superuser)
   GRANT ALL PRIVILEGES ON DATABASE account_db TO kimzinc;
...
\echo 'Database account_db created successfully!'
